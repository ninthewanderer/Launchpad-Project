...
public class OpenCloseWindow : MonoBehaviour
{
    ...
    [SerializeField] private Color gizmoInitialLocationColor = Color.gray;
    ...
    private void InitializeOffsetPositions()
    {
        ...
        _rightOffset = new Vector3(+distanceToAnimate.x, 0);
        _leftOffset = new Vector3(-distanceToAnimate.x, 0);
    }
    ...
    private void RecalculateGizmoPositions()
    {
        ...
        _initialPositionForGizmos = new Vector2(window.transform.position.x, window.transform.position.y) +
                                    windowRectTransform.rect.center;
